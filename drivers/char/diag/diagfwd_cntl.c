	...
	uint8_t pd_val, uint8_t peripheral)
{
	...
	strscpy(new_item->process_name, process_name, sizeof(new_item->process_name));
				      ...
				      uint8_t peripheral)
{
	...
	ctrl_pkt.version = 1;
	strscpy((char *)&ctrl_pkt.process_name, process_name,
		sizeof((char *)&ctrl_pkt.process_name));
